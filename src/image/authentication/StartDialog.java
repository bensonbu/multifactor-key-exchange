...
{
    public static String  selectedlist = null;
 ...
 /**
  * array with ImageDescription's, from AzureImages
  *
  * @see     org.game.Juzzle.ImageDescription
  * @see     org.game.Juzzle.images.AzureImages
  */
 ...
 public StartDialog()
  ...
  // get the images
  imagesList = AzureImages.getImages();

  // create list
  list = new JList(imagesList);
  
      System.out.println("image list jlist: " + imagesList.toString());
 ...
 public ImageDescription getSelectedImage()
  {
      ...
      selectedlist = list.getSelectedValue().toString();
      System.out.println("startDialog selected image file: " +  selectedlist);
