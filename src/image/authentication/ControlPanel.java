...
//  imagePanel_jsp.setPreferredSize(new Dimension(200, 200));
 ...
 public void setImage(Image image)
  ...
  int ih = image.getHeight(null);
   ...
   //   System.out.println("image size from control panel raw : " + imageSize);
 ...
 imagePanel.setIcon(new ImageIcon(image_scaled)); // preview image on internalframe**********************
  
 
      
 
 //  imagePanel.setIcon(new ImageIcon("D:/cut.jpg"));
 ...
 public void printPieces(String s)
  ...
  if(piecesLabel != null)
    piecesLabel.setText(s);
      ...
      System.out.println("print pieces: " + s);
 ...
 public void printSolved(String s)
  {
  if(solvedLabel != null)
    solvedLabel.setText(s); // 88888888888888888888888888888888888888888888888888888
  
     System.out.println("print solved : " +s);
