...
public class PuzzlePartList implements IPuzzlePartList
{
 ...
 public PuzzlePartList(BufferedImage bimage, int x_parts, int y_parts, Dimension random_size)
  ...
  this.bimage = bimage;
   ...
   //   System.out.println("BufferedImage bimage:  " this.bimage);
 ...
 // int random_max_y = random_size.height + partHeight - 60;
   ...
   int random_max_x = 560;
  int random_max_y =  560;
  
      System.out.println("Random size  w  *  h: " + random_size.width + "  "+ random_size.height);
  
      System.out.println("bound must be in puzzlpartlist:  "+ random_max_x +" "+random_max_y);

  // create the array for parts
  pz_array = new PuzzlePartList.PuzzlePart[4];
...
//        node = new PuzzlePart(random.nextInt(780)+10, random.nextInt(780)+10, 0, 0, iw, ih);
  ...
  AffineTransform at = null;
   ...
   System.out.println("puzzlepartlist length:  " + pz_array.length);
  ...
  for(i = 0; i < pz_array.length; i++)
     {
         ...
         System.out.println("puzzlepartlist node:  " + pz_array[i]);
  ...
  public String toString()
   {
       ...
       System.out.println( "PuzzlePart[location: " + locationIn.x + ", " + locationIn.y +
